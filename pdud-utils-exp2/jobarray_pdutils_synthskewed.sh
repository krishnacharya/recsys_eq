#!/bin/bash
#SBATCH -J synth-skewed-pdutils
#SBATCH --array=1-30
#SBATCH -A gts-jziani3
#SBATCH --mem-per-cpu=8G
#SBATCH --time=24:00:00
#SBATCH --output=./Sbatch-reports/synth-skewed-pdutils.%A\_%a.out
#SBATCH --error=./Sbatch-reports/synth-skewed-pdutils.%A\_%a.error

module load anaconda3/2022.05.0.1
conda activate recsys

n=$SLURM_ARRAY_TASK_ID
iteration=`sed -n "${n} p" synthskewed_allseeds_smandlin.csv`      # Get n-th line (1-indexed) of the file
