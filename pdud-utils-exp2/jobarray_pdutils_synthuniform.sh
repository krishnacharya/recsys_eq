...
#SBATCH --error=./Sbatch-reports/synth-uniform-pdutils.%A\_%a.error

module load anaconda3/2022.05.0.1
conda activate recsys

n=$SLURM_ARRAY_TASK_ID
iteration=`sed -n "${n} p" synthuniform_allseeds_smandlin.csv`      # Get n-th line (1-indexed) of the file
