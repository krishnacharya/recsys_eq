...
#SBATCH --output=./Sbatch-eng/rtr-pdutil.%A\_%a.out
#SBATCH --error=./Sbatch-eng/rtr-pdutil.%A\_%a.error

module load anaconda3/2022.05.0.1
conda activate recsys

n=$SLURM_ARRAY_TASK_ID
iteration=`sed -n "${n} p" rtr_smlinrand.csv`      # Get n-th line (1-indexed) of the file
