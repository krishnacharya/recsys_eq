...
df_detailed.to_csv('../csv_results/br_dynamics/linear_detailed_40runs_weighted.csv', encoding='utf-8', index=False)
df_aggr = pd.DataFrame(res_aggregate)
df_aggr.to_csv('../csv_results/br_dynamics/linear_aggr_40runs_weighted.csv', encoding='utf-8', index=False)