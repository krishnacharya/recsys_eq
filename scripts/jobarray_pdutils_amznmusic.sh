#!/bin/bash
#SBATCH -J amznmusic-rerunstopped
#SBATCH --array=1-11
#SBATCH -A gts-jziani3
#SBATCH --mem-per-cpu=10G
#SBATCH --time=3-00:00:00
#SBATCH --output=./Sbatch-reports/amznrerunstopped.%A\_%a.out
#SBATCH --error=./Sbatch-reports/amznrerunstopped.%A\_%a.error

module load anaconda3/2022.05.0.1
conda activate recsys

n=$SLURM_ARRAY_TASK_ID
iteration=`sed -n "${n} p" amznmusic_reruntimout.csv`      # Get n-th line (1-indexed) of the file
