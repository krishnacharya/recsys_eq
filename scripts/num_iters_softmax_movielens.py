...
df_detailed.to_csv('../csv_results/softmax_detailed_40runs_movielens_toy.csv', encoding='utf-8', index=False)
df_aggr = pd.DataFrame(res_aggregate)
df_aggr.to_csv('../csv_results/softmax_aggr_40runs_movielens_toy.csv', encoding='utf-8', index=False)