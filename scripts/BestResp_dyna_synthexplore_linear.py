...
df_detailed.to_csv('../csv_results/num_iters_synthsearch_linear_detailed.csv', encoding='utf-8', index=False)

df_aggr = pd.DataFrame(res_aggregate)
df_aggr.to_csv('../csv_results/num_iters_synthsearch_linear_aggregate.csv', encoding='utf-8', index=False)