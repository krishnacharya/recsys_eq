...
df_detailed.to_csv('../csv_results/br_dynamics/softmax_detailed_40runs_movielens.csv', encoding='utf-8', index=False)
df_aggr = pd.DataFrame(res_aggregate)
df_aggr.to_csv('../csv_results/br_dynamics/softmax_aggr_40runs_movielens.csv', encoding='utf-8', index=False)