...
def main():
    ...
    parser.add_argument('--save_dir', type = str, default = '../saved_frames_expgame/', help= 'directory in which to store the generated dataframe for utility, NE')
    ...
    run_producer_expsoure_game_singleseedsave(common_config['dimensions'], args.emb_seed, common_config['n_prodarr'], \
